...
namespace Targv22.Ivanov
{
    ...
    public partial class Picker_Internet : ContentPage
    {
        Picker picker;
        WebView webView;
        StackLayout st;
        ...
        Button nextButton;
        Frame frame;
        string[] lehed = new string[4] { "https://tahvel.edu.ee", "https://moodle.edu.ee/", "https://www.voanews.com", "https://pavelivanov22.thkit.ee/" };
        int currentIndex = 0;

        public Picker_Internet()
        {
            picker = new Picker
            {
                Title = "Vebilehed"
            ...
            picker.Items.Add("Voa");
            picker.Items.Add("pavelivanov page");
